...
<html>
    <head>
        ...
        <title>Pokemon Search Result</title>
    ...
    <body style="background-color: gold;">
        ...
        try { 
            ...
            ResultSet rs = stmt.executeQuery("SELECT id, name, type, picRef from pokemon, pics WHERE pokemon.id = pics.pokemonID AND name = '" + request.getParameter("name")+ "';");
